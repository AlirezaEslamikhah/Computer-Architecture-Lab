...
HD_PWD='C:/Users/lenovo/Desktop/term5/az_memari/5/shift/shift.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cfg_tb_pipo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cfg_tb_pipo.tcl
